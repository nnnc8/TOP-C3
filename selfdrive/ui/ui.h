...
const QColor bg_colors [] = {
  [STATUS_DISENGAGED] = QColor(0x04, 0x08, 0x12, 0xd8),
  [STATUS_OVERRIDE] = QColor(0x6c, 0x74, 0x82, 0xf1),
  [STATUS_ENGAGED] = QColor(0x7a, 0xae, 0xce, 0xe4),
  // dpatl {{
  [STATUS_ALKA] = QColor(0x9f, 0xd1, 0xec, 0xe4),
  // }} dpatl
};
...
typedef struct UIScene {
  ...
  bool wide_cam; 
  bool friday_toyota_scene_presets;
