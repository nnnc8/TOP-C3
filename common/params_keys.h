...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"FridayAchievements", {PERSISTENT, JSON}},
    {"FridayAchievementToasts", {PERSISTENT, BOOL, "1"}},
    {"FridayJourneyBoard", {PERSISTENT, JSON}},
    {"FridayToyotaScenePresets", {PERSISTENT, BOOL}},
    {"FridayHealthCenter", {PERSISTENT, BOOL, "1"}},
    {"FridayHealthState", {PERSISTENT, JSON}},
    {"FridayHealthSettingsBackups", {PERSISTENT, JSON}},
    {"FridayLongitudinalBrakeAssist", {PERSISTENT, BOOL, "0"}},
    {"FridayBrakeAssistHighConfidenceMin", {PERSISTENT, FLOAT, "0.70"}},
    {"FridayBrakeAssistMidConfidenceMin", {PERSISTENT, FLOAT, "0.45"}},
    {"FridayBrakeAssistMaxDecelHigh", {PERSISTENT, FLOAT, "2.0"}},
    {"FridayBrakeAssistMaxDecelMid", {PERSISTENT, FLOAT, "1.3"}},
    {"FridayBrakeAssistMaxDecelLowFar", {PERSISTENT, FLOAT, "0.45"}},
    {"FridayBrakeAssistMaxDecelLowNear", {PERSISTENT, FLOAT, "1.1"}},
    {"FridayBrakeAssistPrepareM", {PERSISTENT, FLOAT, "80.0"}},
    {"FridayBrakeAssistBrakeM", {PERSISTENT, FLOAT, "30.0"}},
    {"FridayBrakeAssistHardBrakeM", {PERSISTENT, FLOAT, "15.0"}},
    {"FridayBrakeAssistStopM", {PERSISTENT, FLOAT, "8.0"}},
    ...
    {"FridayQuietCabin", {PERSISTENT, BOOL}},
